	...
	<body>
		...
		<div class="banner_box">
			...
			<div class="banner_center">
				<div class="nav_left">	
					<c:forEach items="${OneList}" var="toplist">
						<span>
						${toplist.name}
						</span>
					<p>
						<c:forEach items="${TwoList}" var="Secondlist">
						<c:if test="${Secondlist.parentId==toplist.id}">
						<a href="${ctx}/product/getProductListPage.shtml?categoryId=${Secondlist.id}">${Secondlist.name}</a>
						</c:if>
						</c:forEach>
					</p>
					</c:forEach>
