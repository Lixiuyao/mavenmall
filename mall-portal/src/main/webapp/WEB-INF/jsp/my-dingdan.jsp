...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${ctx}/static/front/css/member.css">
...
<header id="pc-header">
	<div class="pc-header-nav">
		<div class="pc-header-con">
			<div class="fl pc-header-link" >您好！，欢迎来靓淘 <a href="login.html" target="_blank">${user.username}</a> <a href="register.html" target="_blank"> 退出</a></div>
						...
						<ul>
							...
							<li>
								...
								<div class="member-circle clearfix">
									...
									<div class="ci2">${order.receiverName}</div>
