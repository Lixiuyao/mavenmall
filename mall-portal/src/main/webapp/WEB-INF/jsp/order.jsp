...
<head>
	...
	<title>确认订单-靓淘商城</title>
	<link rel="shortcut icon" type="image/x-icon" href="${ctx}/static/front/css/img/icon/favicon.ico">
	...
	<link rel="stylesheet" type="text/css" href="${ctx}/static/front/css/car/base.css">
	<link rel="stylesheet" type="text/css" href="${ctx}/static/front/css/car/home.css">
...
<header id="pc-header">
	...
	<div class="pc-header-logo clearfix">
		<div class="pc-fl-logo fl">
			<h1>
				<a href="index.html"><img src="${ctx}/static/front/img/LOGO.png" /></a>
			</h1>
		</div>
