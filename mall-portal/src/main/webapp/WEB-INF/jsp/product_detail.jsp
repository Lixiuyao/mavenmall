			...
			<div class="right">
				<ul>
					...
					<li class="right_2">
						<ul>
							<li class="right_2_1">
								<img class="img_117" src="/pic/${mainImage}" />
					...
					<li class="right_bottom">
						...
						<ul class="right_bottom_btn">
							<li>
								<input class="right_bottom_add" type="button" value="+" onclick="cal('+')"/>
								<input class="right_bottom_substract" type="button" value="-" onclick="cal('-')" />
							</li>
						</ul>
						<span class="right_txt">
							库存：${product.stock}
