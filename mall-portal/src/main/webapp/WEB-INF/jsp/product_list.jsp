...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="${ctx}/static/front/css/shouji.css" />
		<link rel="stylesheet" href="${ctx}/static/front/css/reset.css" />
		<link rel="stylesheet" href="${ctx}/static/front/css/public.css" />
		<link rel="stylesheet" href="${ctx}/static/front/css/por.css" />
	</head>
	<body>
		<!-----------------------1.top-------------------->
		<div class="bg_color">
