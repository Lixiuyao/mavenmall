...
<body>
  <div class="demoTable">
	     <button class="layui-btn" data-type="search">更新分类</button>
	     <button class="layui-btn layui-btn-danger" data-type="deleteAll">删除分类</button>
	     <select name="quiz1" id="Category" lay-filter="topCategoryFilter">
	        <option value="">请选择分类</option>
	        <option value="one">一级分类</option>
	        <option value="two">二级分类</option>
	    </select>
	      <button class="layui-btn layui-btn-block" data-type="add">添加分类</button>
	 </div>
	 ...
	 <script>
		layui.use('table', function(){
		  ...
		  table.render({
		    ...
		    url:'${ctx}/category/selectTopCategory.action', //异步数据接口
