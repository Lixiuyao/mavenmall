		...
		<form  id="form_add" class="layui-form layui-form-pane" action="" method="post" enctype="multipart/form-data">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="username" required lay-verify="required" value="${user.username}"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="password" required lay-verify="required"  value="${user.password}"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="email" required lay-verify="required"  value="${user.email}"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="phone" placeholder="请输入电话号码" value="${user.phone}"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="question" placeholder="请输入问题" value="${user.question}"
						class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="answer" placeholder="请输入答案" value="${user.answer}"
						class="layui-input">
				</div>
			</div>
			<div class="layui-form-item" pane="">
				...
				<div class="layui-input-block">
					...
					<input type="radio" name="role" value="0" title="屌丝用户" checked="">
			...
			$.ajax({
				...
				success : function(jsonObj) {
					...
					if(jsonObj.code == util.SUCCESS) {
						...
						mylayer.confirm("修改成功，是够跳转到用户列表界面？", "${ctx}/user/getUserpage.action");
					} else {
