	 ...
	 <script>
		layui.use('table', function(){
		  ...
		  table.render({
		    ...
		    url:'${ctx}/order/selectAllOrder.action', //异步数据接口
		    cellMinWidth: 50, //列宽自动分配，全局定义常规单元格的最小宽度
		    cols: [[
		       {type:'checkbox'},
		      {field:'id', title: '编号', sort: true},
		      {field:'username', title: '下单账号', sort: true},
		      {field:'orderNo', title: '订单编号', sort: true},
		      {field:'payment', title: '总金额', sort: true},
				    ...
				    if(layEvent === 'detail'){ //查看
				    	//编辑
					      ...
					      layer.open({
					    	  ...
					    	  content : '${ctx}/order/toOrderItemm.action?orderNo=' + data.orderNo
					      });
